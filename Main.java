...
class Main extends JFrame
{
    ...
    public Main()
    {
        ...
        JButton round2 = new JButton("ROUND 2");
        round2.setSize(100,30);
        round2.setLocation(170,330);
        round2.setBackground(Color.LIGHT_GRAY);
        buttonListener4 = new ButtonListener4();
        round2.addActionListener(buttonListener4);
    ...
    private class ButtonListener implements ActionListener
    {
        ...
        {   
            ...
            if (count ==15)
            {
            	...
            	{
            		trylabel.setText("You win and Your score is !!"+(bestScore = 150 - count*10));
            		if(count==1)
            		{
            			bestScore=150;
