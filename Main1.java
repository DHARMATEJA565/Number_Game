...
class Main1 extends JFrame
{
    ...
    public Main1()
    {
        ...
        guesslabel.setFont(new Font("monospace",Font.ITALIC,24));
	    ...
	    trylabel.setForeground(Color.BLUE);
        ...
        JButton round3 = new JButton("ROUND 3");
        round3.setSize(100,30);
        round3.setLocation(170,330);
        round3.setBackground(Color.LIGHT_GRAY);
        buttonListener4 = new ButtonListener4();
        round3.addActionListener(buttonListener4);
